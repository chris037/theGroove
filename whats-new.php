...
<html lang="en">
    <head>
        ...
        <link href="css/the-groove-style.css" rel="stylesheet" type="text/css" media="all" />
    ...
    <body>
                    ...
                    <div class="row">
                        <div class="col-md-9 mb-xs-24">
                            <div class="col-sm-4 post-snippet">
                                ...
                                <div class="inner">
                                    <a href="#">
                                        <h5 class="mb0">Sed ut perspiciatis unde omnis</h5>
                                ...
                                <ul class="latest-post">
                                    <li>
                                        ...
                                        <div class="description">
                                            <a href="#">Sed ut perspiciatis unde omnis iste natus error sit voluptatem antium doloremque</a>
                                        </div>
                                        <hr>
            ...
            <footer class="footer-1">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-12">
                                <span>All Rights Reserved. Rockwell Corporation &copy; 2015</span>
                        </div>
                        <div class="col-md-4 col-sm-12">
                             <ul>
                                <li>
                                    <a href="#"><img src="img/fbIcons.png"> thegrovebyrockwell</a>
                                </li>
                                <li>
                                    <a href="#"><img src="img/intagramIcons.png"> @thegrovebyrockwell</a>
                                </li>
                            </ul>
                        </div>
        ...
        <script src="js/groove.js"></script>
