...
<section class="unitType text-center">
    <div class="row">
        <div class="col-md-12">
            <a href="#" class="items gotoPlan">
                <h4 class="uppercase bold mb8">1-BEDROOM</h4>
                <h6>INUT AREA RANGE:51-63 SQM</h6>
            </a>
            <a href="#" class="items gotoPlan">
                <h4 class="uppercase bold mb8">2-BEDROOM</h4>
                <h6>INUT AREA RANGE:51-63 SQM</h6>
            </a>
            <a href="#" class="items gotoPlan">
                <h4 class="uppercase bold mb8">3-BEDROOM</h4>
                <h6>INUT AREA RANGE:51-63 SQM</h6>
            </a>
        </div>
    </div>
    ...
    <div class="col-md-8 col-sm-6 col-xs-12 text-left content-box">
        <div class="pt24 pb24">
            <div class="col-md-2 text-center">
                <a href="#" class="uppercase back text-center backfloorPlan"> <i class="ti-arrow-left"></i><br/><h5>BACK</h5></a>
            </div>
            <div class="col-md-10">
                <h4 class="uppercase mb8 bold">TOWER A-D</h4>
