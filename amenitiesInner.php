...
<section class="cover fullscreen image-slider model-unit-slider slider-all-controls controls-inside">
    <ul class="slides">
        <li class="overlay image-bg bg-light">
            <div class="background-image-holder">
                <img alt="image" class="background-image" src="img/amenitiesBanner.jpg" />
            </div>
        </li>
        <li class="overlay image-bg bg-light">
            <div class="background-image-holder">
    ...
    <div class="col-md-8 col-sm-6 col-xs-12 text-left content-box">
        <div class="pt24 pb24">
            <div class="col-md-2 text-center">
                <a href="#" class="uppercase back text-center backAmenities"> <i class="ti-arrow-left"></i><br/><h5>BACK</h5></a>
            </div>
            <div class="col-md-10">
                <h4 class="uppercase mb8 bold">2 LEVEL RETAIL SPACE</h4>
