    ...
    <ul class="slides">
        <li class="overlay image-bg bg-light">
            <div class="background-image-holder">
                <img alt="image" class="background-image" src="img/model-unit-banner.jpg" />
            </div>
        </li>
        <li class="overlay image-bg bg-light">
            <div class="background-image-holder">
    ...
    <div class="col-md-8 col-sm-6 col-xs-12 text-left content-box">
        <div class="pt24 pb24">
            <div class="col-md-2 text-center">
                <a href="#" class="uppercase back text-center backModelUnit"> <i class="ti-arrow-left"></i><br/><h5>BACK</h5></a>
            </div>
            <div class="col-md-10">
                <h4 class="uppercase mb8 bold">1 BEDROOM (41 SQM)</h4>
