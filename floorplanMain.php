...
<section class="image-nav-wrapper">
    <div class="row">
        <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="row">
                <div class="image-tile hover-tile text-center">
                        <img alt="image" class="background-image" src="img/floorplan-1.jpg" />
                            <div class="hover-state">
                                <a href="#" class="gotoUnitType">
                                     <i class="ti-search"></i>
                                    <h4 class="uppercase mb8">TOWER A-D</h4>
                                </a>
                            </div>
                </div>
            </div>
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="row">
                <div class="image-tile hover-tile text-center">
                        <img alt="image" class="background-image" src="img/floorplan-2.jpg" />
                            <div class="hover-state">
                                <a href="#" class="gotoUnitType">
                                    <i class="ti-search"></i>
                                    <h4 class="uppercase mb8">TOWER E-F</h4>
                                </a>
                            </div>
                </div>
            </div>
...
<section class="content-box-wrapper pt0 pb0">
    <div class="col-md-8 col-sm-6 col-xs-12 text-left content-box">
        <div class="pt24 pb24">
            <h4 class="uppercase mb8 bold">SITE DEVELOPMENT PLAN</h4>
